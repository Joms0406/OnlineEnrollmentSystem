...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $course = $_POST['course'];
     ...
     $sql2 = "INSERT INTO enrollment (enrollment_date_time, remarks, student_id, section_id, user_id, course_id, year_level_id, curriculum_id) 
        VALUES (NOW(), 'Student', '$student_id', '1', '1','$course','1','1')";
