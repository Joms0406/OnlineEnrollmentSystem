...
(123, 'BSCS', '2021-10-15 07:19:09', '2021-10-15 07:19:09', NULL),
(124, 'BSCRIM', '2021-10-15 07:19:09', '2021-10-15 07:19:09', NULL),
...
(10101, 'Bachelor of Science in Computer Science', '2021-10-20 09:02:21', NULL, 'First Year 1st Sem - BSCS', 1, 10101, 123, 1, 123, 123),
(10101, 'Bachelor of Science in Computer Science', '2021-10-20 09:02:21', NULL, 'First Year 1st Sem - BSCS', 1, 10102, 123, 1, 123, 123),
(10101, 'Bachelor of Science in Computer Science', '2021-10-20 09:13:22', NULL, 'First Year 1st Sem - BSCS', 1, 10103, 123, 1, 123, 123),
(10101, 'Bachelor of Science in Computer Science', '2021-10-20 09:13:22', NULL, 'First Year 1st Sem - BSCS', 1, 10104, 123, 1, 123, 123),
(10101, 'Bachelor of Science in Computer Science', '2021-10-20 09:15:03', NULL, 'First Year 1st Sem - BSCS', 1, 10105, 123, 1, 123, 123),
(10101, 'Bachelor of Science in Computer Science', '2021-10-20 09:15:03', NULL, 'First Year 1st Sem - BSCS', 1, 10106, 123, 1, 123, 123),
(10101, 'Bachelor of Science in Computer Science', '2021-10-20 09:15:03', NULL, 'First Year 1st Sem - BSCS', 1, 10107, 123, 1, 123, 123),
(10101, 'Bachelor of Science in Computer Science', '2021-10-20 09:15:03', NULL, 'First Year 1st Sem - BSCS', 1, 10108, 123, 1, 123, 123),
(10201, 'Bachelor of Science in Computer Science', '2021-10-20 09:40:59', NULL, 'First Year 2nd Sem - BSCS', 1, 10103, 123, 1, 123, 123),
(10201, 'Bachelor of Science in Computer Science', '2021-10-20 09:38:41', NULL, 'First Year 2nd Sem - BSCS', 1, 10201, 123, 1, 123, 123),
(10201, 'Bachelor of Science in Computer Science', '2021-10-20 09:38:41', NULL, 'First Year 2nd Sem - BSCS', 1, 10202, 123, 1, 123, 123),
(10201, 'Bachelor of Science in Computer Science', '2021-10-20 09:40:59', NULL, 'First Year 2nd Sem - BSCS', 1, 10204, 123, 1, 123, 123),
(10201, 'Bachelor of Science in Computer Science', '2021-10-20 09:45:52', NULL, 'First Year 2nd Sem - BSCS', 1, 10205, 123, 1, 123, 123),
(10201, 'Bachelor of Science in Computer Science', '2021-10-20 09:46:53', NULL, 'First Year 2nd Sem - BSCS', 1, 10206, 123, 1, 123, 123),
(10202, 'BS HRM', NULL, NULL, NULL, 2, 10207, 125, 1, 123, 123),
(10203, 'Bachelor of Science in Computer Science', '2021-10-20 09:02:21', NULL, 'First Year 1st Sem - BSCS', 4, 10101, 123, 1, 123, 123),
(10204, 'Bachelor of Science in Computer Science', '2021-10-20 09:02:21', NULL, 'First Year 1st Sem - BSCS', 4, 10102, 123, 1, 123, 123),
(10205, 'Bachelor of Science in Computer Science', '2021-10-20 09:13:22', NULL, 'First Year 1st Sem - BSCS', 4, 10103, 123, 1, 123, 123);
...
(123, '2021-2022', '2021-10-15 07:19:59', '2021-10-15 07:19:59', NULL);
...
(123, 'Set A', '2021-10-15 07:20:21', '2021-10-15 07:20:21', NULL),
(124, 'Set B', '2021-10-15 07:20:21', '2021-10-15 07:20:21', NULL);
...
(123, '1st Semester', '2021-10-15 07:21:58', '2021-10-15 07:21:58', NULL),
(124, '2nd Semester', '2021-10-15 07:21:58', '2021-10-15 07:21:58', NULL);
...
(10207, 'HRM 101', 'HRM 101', 3, NULL, NULL, NULL);
...
(1, '1st Year', '2021-10-15 07:25:02', '2021-10-15 07:25:02', NULL),
...
ALTER TABLE `irregular_curriculum_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `irregular_curriculum_details_ibfk_1` (`curriculum_id`),
  ADD KEY `irregular_curriculum_details_ibfk_2` (`subject_id`),
  ADD KEY `irregular_curriculum_details_ibfk_3` (`course_id`),
  ADD KEY `irregular_curriculum_details_ibfk_4` (`year_level_id`),
  ADD KEY `irregular_curriculum_details_ibfk_5` (`semester_id`),
  ADD KEY `irregular_curriculum_details_ibfk_6` (`school_year_id`);
...
ALTER TABLE `requirements`
  ...
  ADD KEY `requirements_ibfk_1` (`student_id`);
...
--
-- AUTO_INCREMENT for table `curriculum_details`
--
ALTER TABLE `curriculum_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10206;
