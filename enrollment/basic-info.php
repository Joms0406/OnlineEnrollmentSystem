...
<div class="container1">
	<form form id="basic-info" method = "POST" enctype="multipart/form-data">
        <h1>Basic Info:</h1>
        ...
        <div class="tab">
            First Name:
            <p> <input type="input" name="first_name"> <br></p>
            Middle Name:
            <p> <input type="input" name="middle_name"> <br></p>
            Last Name:
            <p> <input type="input" name="last_name"> <br></p>
            Email:
            <p> <input type="input" name="email"> <br></p>
            Contact:
            <p><input type="input" name="contact" minlength="10" maxlength="10"><br></p>
        </div>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // if save button on the form is clicked
    ...
    if($query){
        ...
        $destination = 'data/image/requirement/freshmen/' . $filename;
        ...
        if (!in_array($extension, ['pdf'])) {
            ...
            if (move_uploaded_file($file, $destination)) {
                $sql = "INSERT INTO requirements (student_id, file_name, size, path) VALUES ('$student_id', '$filename', $size, '$destination')";
